...
### Fixed
- **Run.bat**: Corregido el protocolo `https` por `http` en el script de arranque, solucionando el error `ERR_SSL_PROTOCOL_ERROR` al abrir `localhost` en el navegador.
